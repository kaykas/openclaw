...
| `qa-smoke-ci-artifacts`            | Build the private QA runtime and package once for all QA Smoke profile parts                                                                                                                       | Node-relevant changes                               |
| `qa-smoke-ci-shard`                | Two balanced QA Smoke profile parts that reuse the shared QA runtime/package; each channel-compatible subrun stays inside its assigned part                                                        | Node-relevant changes                               |
